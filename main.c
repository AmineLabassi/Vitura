...
int main() {
    ...
    int continuer = 1;//var pour contrl boucle principale
    SDL_Event event;//stock events (clavier,souris)
    enigme e;
    ...
    while (continuer) {
        ...
        if (check_timer(&e)) {
            ...
            generer_enigme(&e);
	    // In your main function, after generer_enigme(&e);
	    e.rotation_angle = 0;
        }//taawed enigeme okhra ken el wakt wfee
        ...
        SDL_FillRect(ecran, NULL, 0);//efface l'ecran
        SDL_BlitSurface(background, NULL, ecran, NULL);//tlasak el bg
        SDL_BlitSurface(e.question, NULL, ecran, &e.pos_question);//aff ques
        SDL_BlitSurface(e.timer[e.num_animation], NULL, ecran, &e.pos_timer);//aff animation timer
