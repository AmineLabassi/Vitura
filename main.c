	/**
 * @file main.c
 * @brief Jeu SDL avec nom joueur, scrolling, split-screen, score et affichage des meilleurs scores.
 */
        #include <stdlib.h>
	#include <SDL/SDL.h>
...
background robot; /**< Structure de fond animée */

SDL_Surface *iconeGuide = NULL; /**< Icône de guide affichée à l’écran */
Uint32 start_time;              /**< Temps global de démarrage du jeu */
int score = 0;                  /**< Score du joueur */
        /**
 * @brief Fonction principale du programme
 *
 * Gère l'initialisation SDL, la récupération du nom du joueur,
 * le chargement des images et musiques, la boucle de jeu avec split-screen,
 * l'affichage du score et des meilleurs résultats.
 *
 ...
 */
	...
	// Charger l'image nom.jpg
	SDL_Surface *nom_bg = IMG_Load("nom.jpg");
	if (!nom_bg) {
	    fprintf(stderr, "Erreur chargement nom.jpg : %s\n", IMG_GetError());
	    return 1;
	}
	...
	// Réafficher l'image nom.jpg centrée
...
SDL_Surface *best_img = IMG_Load("best.jpg");
if (!best_img) {
    fprintf(stderr, "Erreur chargement best.jpg : %s\n", IMG_GetError());
} else {
